...
size = 2
haar_cascade = cv2.CascadeClassifier(r'C:\Users\91967\AppData\Local\Programs\Python\Python312\Facial-Recognition-for-Crime-Detection-master\Advanced Identity Recognition\face_cascade.xml')
    ...
    for (subdirs, dirs, files) in os.walk(fn_dir):
        ...
        for subdir in dirs:
            ...
            if not os.path.exists(subjectpath):
                print(f"Directory {subjectpath} not found, skipping...")
                continue
